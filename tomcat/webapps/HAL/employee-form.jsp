...
<body>
    ...
    <div class="app-container" style="position: relative; padding-top: 4px;">
        ...
        <div class="main-content">
            <div class="top-bar">
                <div class="top-bar-title"><%= isEdit ? "Modify Employee File" : "Register Employee File" %> - Overhaul Division</div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="designation" name="designation" class="form-control" 
                                       placeholder="e.g. General Manager, Additional General Manager" required value="<%= emp.getDesignation() != null ? emp.getDesignation() : "" %>">
                            </div>
